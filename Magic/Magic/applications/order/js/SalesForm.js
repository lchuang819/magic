SalesForm = Ext.extend(Ext.magic.MagicForm, {
	id:'SalesForm',
	title:'销售单',
	labelWidth:100,
	labelAlign:"right",
...
//	        width:1100,
		...
		var SalesGrid = Ext.extend(Ext.grid.EditorGridPanel, {
//		    renderTo: 'user-grid',
			id:'SalesGrid',
		    iconCls: 'icon-grid',
		    frame: true,
...
//		        this.buttons = this.buildUI();
				SalesGrid.superclass.initComponent.call(this);
		    },
		    constructor: function(config){
...
//		 		});
		         ...
		         // super
		         SalesGrid.superclass.constructor.call(this, {store:prodCatalogStore, columns:colModel});
		    },
...
//		        var rec = this.store.getAt(index[0]);
			...
			doAction:function(params){
				...
				this.store.setBaseParam('orderTypeId', "SALES_ORDER");
		...
		this.buttons = [{
				        	...
				        	showResult:function(btn){
				        		if(btn == 'yes'){
				        			...
				        			Ext.getCmp('SalesForm').destroy();
				        		}
				        	}
				        },{
				            text: '重置',
				            type:'reset',
				            handler:function(){Ext.getCmp('SalesForm').form.reset();}
				        }];
		SalesForm.superclass.constructor.call(this);
	},
	configComponent:function(options){
