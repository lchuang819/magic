StockReturnForm = Ext.extend(Ext.magic.MagicForm, {
	id:'StockReturnForm',
	title:'进货退货单',
	labelWidth:100,
	labelAlign:"right",
	...
	constructor: function(config){
		...
		var stockReturnBasicInfoFs = new Ext.form.FieldSet({
			id:'stockReturnBasicInfoFs',
			xtype: 'fieldset',
//	        title: '基本信息',
	        autoHeight:true,
	        //labelWidth:120,
//	        width:1100,
		...
		var StockReturnGrid = Ext.extend(Ext.grid.EditorGridPanel, {
//		    renderTo: 'user-grid',
			id:'StockReturnGrid',
		    iconCls: 'icon-grid',
		    frame: true,
...
//		        this.buttons = this.buildUI();
		        StockReturnGrid.superclass.initComponent.call(this);
		    },
		    constructor: function(config){
...
//		 		});
		         ...
		         // super
		    	 StockReturnGrid.superclass.constructor.call(this, {store:prodCatalogStore, columns:colModel});
		    },
...
//		        var rec = this.store.getAt(index[0]);
			...
			doAction:function(params){
				...
				this.store.setBaseParam('orderTypeId', "PURCHASE_RETURN_ORDER");
		...
		var grid = new StockReturnGrid();
		
		this.items = [
		              stockReturnBasicInfoFs,
		              grid
		              ];
		...
		this.buttons = [{
				        	...
				        	showResult:function(btn){
				        		if(btn == 'yes'){
				        			Ext.getCmp('StockReturnForm').form.reset();
				        			grid.store.removeAll();
				        		}else{
				        			Ext.getCmp('StockReturnForm').destroy();
				        		}
				        	}
				        },{
				            text: '重置',
				            type:'reset',
				            handler:function(){Ext.getCmp('StockReturnForm').form.reset();}
				        }];
		StockReturnForm.superclass.constructor.call(this);
	},
	configComponent:function(options){
