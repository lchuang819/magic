...
/**
 	* A data access object (DAO) providing persistence and search support for BuildUserMenus entities.
...
public class BuildUserMenusDAO extends BaseHibernateDAO  {
    private static final Log log = LogFactory.getLog(BuildUserMenusDAO.class);
	//property constants
    ...
    public void save(BuildUserMenus transientInstance) {
        log.debug("saving BuildUserMenus instance");
        try {
    ...
    public BuildUserMenus findById( com.magic.entitymodel.BuildUserMenusId id) {
        ...
        try {
            BuildUserMenus instance = (BuildUserMenus) getSession()
                    .get("com.magic.entitymodel.BuildUserMenus", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(BuildUserMenus instance) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding BuildUserMenus instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from BuildUserMenus as model where model." 
         						+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all BuildUserMenus instances");
		try {
			String queryString = "from BuildUserMenus";
	         Query queryObject = getSession().createQuery(queryString);
			 return queryObject.list();
		} catch (RuntimeException re) {
    ...
    public BuildUserMenus merge(BuildUserMenus detachedInstance) {
        ...
        try {
            BuildUserMenus result = (BuildUserMenus) getSession()
